...
(() => {
  ...
  const st = {
    ...
    u: { p: "dashboard", pp: 1, ap: 1, cp: 1, items: [], cItems: [], f: { from: "", to: "", agentId: "all" } },
  ...
  const CO = {
    ...
    save() {
      ...
      st.d.customerOrders.push({ id: U.id(), customerId: cid, date, items, total });
      DB.save();
      this.reset();
      R.all();
      UI.toast("تم حفظ طلبية العميل");
    }
  };
